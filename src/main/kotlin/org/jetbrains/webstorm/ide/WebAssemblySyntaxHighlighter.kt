...
class WebAssemblySyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    private val tokenMap: Map<IElementType, WebAssemblyColor> =
        hashMapOf(
            ...
            REFDOTISNULLINST to WebAssemblyColor.RESERVED,
            REFDOTNULLINSTR to WebAssemblyColor.RESERVED,
            REFDOTFUNCINSTR to WebAssemblyColor.RESERVED,
            ...
            TABLEINSTR_IDX_IDX to WebAssemblyColor.RESERVED,
            TABLEINSTR_IDX_ELIDX to WebAssemblyColor.RESERVED,
            TABLEINSTR_ELIDX to WebAssemblyColor.RESERVED,
